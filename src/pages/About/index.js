        ...
        <MuiCard variant="outlined" sx={{ border: 'none' }}>
          ...
          >
            ...
            >
              ...
              relentless pursuit of excellence, allowed us to overcome
              challenges and grow. From humble beginnings, we've continuously
              evolved, always striving to meet the ever-changing needs of our
              customers.
            </Typography>
            ...
            <Typography
              ...
              sx={{ marginTop: '40px' }}
            >
              As a business, we believe in integrity, quality, and innovation.
              Our mission is to provide exceptional products that not only meet
              but exceed expectations. We are committed to creating an inclusive
              and ethical environment, where each customer experience is
              prioritized. Sustainability and responsibility guide our decisions
              as we continue to innovate and adapt to future challenges,
              ensuring that we leave a positive impact on both our community and
              the world.
            </Typography>
          </Box>
        </MuiCard>
